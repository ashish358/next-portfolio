...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, isMobile ? 1 : 2.96]);
  const scaleY = useTransform(scrollYProgress, [0, 0.3], [0.6, isMobile ? 1 : 1.9]);
  const translate = useTransform(scrollYProgress, [0, 1], [0, 1481]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[300vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50 overflow-y-hidden"
    >
      <motion.h2
      ...
      <Lid scaleX={scaleX} scaleY={scaleY} rotate={rotate} translate={translate} src={src} />
...
export const Lid = ({
  ...
  const inverseScaleX = useTransform(scaleX, (value) => 1 / value);
  const inverseScaleY = useTransform(scaleY, (value) => 1 / value);
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        <div
          ...
          className="absolute inset-0 bg-[#010101] flex items-center justify-center"
        >
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] pl-4 overflow-y-auto scrollbar-hide"
      >
        <motion.div
          style={{
...
export const OptionKey = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      />
      <rect className="opacity-0" width="32" height="32" stroke="none" />
    </svg>
  );
};
